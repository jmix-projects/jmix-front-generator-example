...
const xKeyQuestion: StudioTemplateProperty = {
    caption: "X data attribute",
    code: "xKey",
...
const yKeyQuestion: StudioTemplateProperty = {
    caption: "Y data attribute",
    code: "yKey",
    propertyType: StudioTemplatePropertyType.ATTRIBUTE,
    required: true,
    options: ["number"],
...
export const chartComponentQuestions: StudioTemplateProperty[] = [
    entityQuestion,
    createComponentNameQuestion({defaultValue: 'LineChart'}),
    createQueryQuestion(),
    yKeyQuestion,
    xKeyQuestion,
    menuItemQuestion,
